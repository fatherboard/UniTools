				...
				<div class="fb-col b1">
					...
					<div class="fb-row sbs_b">
						<div class="fb-col sbs_e" id="pr_data">
							...
							<div class="b2 fb-col">
							<ul>
								<li>Creado por: <?php echo $username?></li>
								<li>Lenguaje:  <?php echo $lenguaje?> </li>
								<li> 
						...
						<div class="fb-col sbs_e" id="pr_cont">
							<div class="t2 gr_black">
							Contenido
							</div>
							<div class="b2 fb-col">
					...
					<div class="fb-row">
						...
						<div class="fb-col" id="pr_newperm">
							<div class="t2 gr_black">
								Añadir Permiso
							</div>
							<div class="b2 fb-col">
								<form action="" method="POST" id="addPermiso"></form>
								Usuario: <input type="text" name="user" form="addPermiso"/>
								<div id="pr_tipo">
