...
\begin{figure}[h]
 \centering
  \includegraphics[width=0.8463\linewidth]{2.jpg}
\end{figure}
...
En la siguiente tabla se describe la aportación que cada miembro del equipo ha realizado para esta entrega de nuestro Proyecto.

\begin{table}[h]
\begin{tabular}{@{}|l|l|@{}}
\toprule
\textbf{Miembro} & \textbf{Actividades}                                                                                                                                   \\ \midrule
Luis Cepeda      & Dirigido la mejora del CSS.                                                                                                                            \\ \midrule
Carlos Bilbao    & \begin{tabular}[c]{@{}l@{}}Redactado la Memoria. Ha hecho todo lo relacionado con Proyectos.\\  Hizo junto a Bruno lo relativo a Forms.\end{tabular}   \\ \midrule
Hugo Ribeiro     & Ayudado con la Base de Datos, el CSS y la funcionalidad.                                                                                               \\ \midrule
...
Fernando Muñoz   & \begin{tabular}[c]{@{}l@{}}Añadido la funcionalidad de suscripción premium y \\ la barra de búsqueda.\end{tabular}                                     \\ \midrule
